...
export class Account {
    ...
    */
    static from_private_key(private_key) {
        ...
        const ret = wasm.account_from_private_key(ptr0, len0);
        return Account.__wrap(ret);
    }
    /**
    ...
    */
    static from_seed(seed) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.account_from_seed(ptr0, len0);
        return Account.__wrap(ret);
    }
    /**
    * @returns {string}
    ...
    * @returns {Uint8Array}
    */
    sign(message, rng_seed) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(message, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passArray8ToWasm0(rng_seed, wasm.__wbindgen_malloc);
            const len1 = WASM_VECTOR_LEN;
            wasm.account_sign(retptr, this.ptr, ptr0, len0, ptr1, len1);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
...
export class Address {
    ...
    */
    static from_private_key(private_key) {
        const ptr0 = passStringToWasm0(private_key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.address_from_private_key(ptr0, len0);
    ...
    */
    static from_view_key(view_key) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.address_from_view_key(ptr0, len0);
        return Address.__wrap(ret);
    }
    /**
    ...
    */
    verify_signature(message, signature) {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.address_verify_signature(this.ptr, ptr0, len0, ptr1, len1);
        return ret !== 0;
    }
    /**
    * @returns {string}
...
export class ViewKey {
    ...
    */
    static from_private_key(private_key) {
        const ptr0 = passStringToWasm0(private_key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.viewkey_from_private_key(ptr0, len0);
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('sdk_bg.wasm', import.meta.url);
    }
    const imports = getImports();
